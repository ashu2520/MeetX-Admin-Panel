...
const NavBar = () => {
  ...
  useEffect(() => {
    if (isTokenChecked && (!isLoggedIn || !isTokenValid)) {
      ...
      alert("You are not logged in or session has timed out. Please login to continue.");
      window.location.href = "/";
      return (
  ...
  return(
    <>
    <div className="h-screen flex justify-center items-center text-2xl">Redirecting to Login Page...</div>
    </>
  )
};
